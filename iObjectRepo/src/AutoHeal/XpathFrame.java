...
public class XpathFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        xpathPanel.setBackground(new java.awt.Color(0, 57, 23));

        xpathLabel.setForeground(new java.awt.Color(255, 255, 255));
        xpathLabel.setText("Do you want capture Xpath?");
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
             ...
             String pgaeSource = driver.getPageSource();
               ...
               // String pgaeSource = js.executeScript("document.documentElement.innerHTML;").toString();
               // XpathCapture x = new XpathCapture();
                GuidewireXpathCreation x = new GuidewireXpathCreation();
                x.xpath(pgaeSource, driver, true);
