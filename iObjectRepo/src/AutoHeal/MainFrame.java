...
public class MainFrame extends javax.swing.JFrame {
    ...
    static File directory = new File("src");
    public static final Color COLOR = new Color(0, 57, 23);//(32, 89, 89);
    public static final String DRIVER_PATH = directory.getAbsolutePath()+"\\chromedriver_win32\\chromedriver.exe";
    //public static final String DRIVER_PATH = "C:\\newWorkSpace\\AutoSpy\\Jars\\chromedriver_win32\\chromedriver.exe";
    public static final String IMAGE_1 = directory.getAbsolutePath()+"\\icon\\image2.PNG";
    public static final String IMAGE_2 = directory.getAbsolutePath()+"\\icon\\image2.PNG";
    public static final String IMAGE_3 = directory.getAbsolutePath()+"\\icon\\processing1234.GIF";
    public static final String IMAGE_4 = directory.getAbsolutePath()+"\\icon\\processing1234.GIF";
    public static final String IMAGE_5 = directory.getAbsolutePath()+"\\icon\\Untitled - Copy.png";
    ...
    public MainFrame() {
        ...
        setTitle("");
        //setIconImage(new ImageIcon(IMAGE_5).getImage());
        setIconImage(new ImageIcon(IMAGE_5).getImage());
        setResizable(false);
        //setUndecorated(true);
        setBackground(COLOR);
        ...
        initComponents();
        ///header.setIcon(new ImageIcon(IMAGE_5));
    ...
    private void initComponents() {
        ...
        layoutPanel.setBackground(new java.awt.Color(0, 57, 23));
        layoutPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "iObjectRepo", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Cambria Math", 1, 18), new java.awt.Color(255, 255, 0))); //0, 204, 204 NOI18N
        //
        ...
        body.setBackground(new java.awt.Color(0, 57, 23));
